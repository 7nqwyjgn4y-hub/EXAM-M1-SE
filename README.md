...
Sauvegardez le code et placez le fichier de code à côté de l'extraction Instagram au sein du même dossier (le dossier vierge créé au préalable). Maintenant, vous pouvez exécuter le code en Markdown et générer un fichier plus lisible en HTML (Knit) si vous le souhaitez.
